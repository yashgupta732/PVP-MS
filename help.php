...
<body>
   ...
   <div class = "col-lg-6 m-auto mcon" style = "border-radius: none;">
      ...
      <h2><strong> How To Register For PvP? </strong></h2>
      ...
      <h3 style = "text-shadow: 0.5px 0.5px black;padding-right: 10px;"> STUDENTS ELIGIBLE TO REGISTER FOR PVP:</h3>
      ...
      <h4 style = "text-shadow: 0.5px 0.5px black;padding-right: 10px;"> NOTE: CANNOT REGISTER FOR PVP BEFORE SEE RESULT</h4>

...
<body>
    <div id="progress"></div>
    <nav class="navbar navbar-light" style="background-color: #07698c;margin-bottom:2%;border-bottom: 2px solid black;box-shadow: 3px 3px 5px black;">
        <a class="mh3 navbar-brand text-white" style="font-family:'Acme';font-size:30px" href="http://www.rvce.edu.in">RVCE</a>

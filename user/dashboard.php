...
if (!$rr) {
    $exerrr = "<font color='red';font-family:'Acme';>You have not registered for PvP yet!</font>";
} else {
...
<head>
    ...
    <meta name="author" content="DBS Lab">
    ...
    <div class="wrapper">
        <div class="sidebar col -l2 -s4">
            <ul>
                ...
                <li><a href="dashboard.php?page=register"><i class="fas fa-pen"></i>Register For PvP</a></li>
                <li><a href="dashboard.php?page=subjects_reg"><i class="far fa-file"></i> Registered Subjects</a></li>
                <li><a href="dashboard.php?page=time_table"><i class="far fa-file"></i> Check For PvP Result</a></li>
                <li><a href="dashboard.php?page=chatbot"></> ? Help</a></li>
                <!-- <li><a href="dashboard.php?page=fast_reg"><i class="fas fa-pen"></i>Register For PvP</a></li>  -->
            </ul>
        </div>
